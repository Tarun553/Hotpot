            ...
            {characters.map((char, index) => {
                ...
                return (
                    <div key={index} style={charStyle}>
                        ...
                        <span
                            className="text-base md:text-lg font-bold font-pixelated text-slate-800 dark:text-slate-200">
                            {char}
                        </span>
                    </div>
                );
...
export function Component() {
    ...
    return (
        <div
            className="flex items-center justify-center w-full min-h-screen bg-slate-100 dark:bg-black transition-colors duration-500">
            <div className="relative flex items-center justify-center">
                ...
                <motion.div
                 ...
                 <div
                    ...
                    <div
                        className="absolute w-[200%] h-[200%] top-[-50%] left-[-50%] animate-grain"></div>
                </div>
            </div>
